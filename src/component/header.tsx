...
export const Header = () => {
    ...
    return( 
        ...
        <div className="flex items-center justify-between w-full max-w-screen-xl px-5">
          ...
          <div className=" flex items-center gap-x-3">
            <button className="bg-background rounded-md … w-[97px] h-9 px-4 py-2 items-center justify-center border inline-flex">
              <img src="down.png" />
              Genre
            </button>
            <div>
              <div className="relative text-muted-foreground w-[379px]">
                <input
                  type="text"
                  placeholder="search..."
                  className="flex h-9 w-full rounded-md border border-input bg-transparent px-3 py-1 text-base pl-[38px]"
                />
              </div>
            </div>
          </div>
          <div className="flex items-center gap-x-3">
            <button className="inline-flex items-center justify-center gap-2 bg-background border h-9 w-9 rounded-md">
              <svg
                width="16"
                height="17"
                viewBox="0 0 16 17"
