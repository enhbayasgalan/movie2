...
export const Upcoming = (props: props) => {
  ...
  const SimilarMovie = async () => {
    try {
      const responseSimilar = await fetch(
        `https://api.themoviedb.org/3/movie/${props.title}/similar?language=en-US&page=${currentPage}&api_key=db430a8098715f8fab36009f57dff9fb`
      );
  ...
  useEffect(() => {
    {
      (parseInt(nameValue) / 1 == parseInt(nameValue)) == true
        ? SimilarMovie()
        : MovieData();
    }
    folderset();
    ...
    <div>
      <section className="py-8 top-10 lg:py-13 space-y-8">
        <div className="max-w-[1280px] w-full flex flex-col justify-center justify-between ">
          <div className="flex items-center justify-center">
            ...
            {folder == "app" && (
              <p
                ...
                onClick={() => router.push(`/seemore/${name}`)}
              >
                Seemore...
              </p>
            )}
          ...
          {folder == "app" && (
            <div className="flex flex-wrap gap-5 lg:gap-8 py-8 px-4 lg:px-0">
                ...
                >
                  <div className="overflow-hidden flex flex-col justify-center max-w-full h- [400px] group">
                    ...
                    <div className="p-2 ">
                      ...
                      <div className="h-14 line-clamp-2 text-lg ">
          ...
          {folder == "seemore" && (
            <div className="flex flex-wrap px-4 lg:px-0 items-center justify-center py-8 gap-8  ">
